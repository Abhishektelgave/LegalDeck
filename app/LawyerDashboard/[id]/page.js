...
const AppointmentDetails = ({ params }) => {
    ...
    return (
        <div className="min-h-screen p-8 bg-[#151515] cursor-default text-white">
            <div className="max-w-3xl mx-auto bg-black border border-white/20 p-8 rounded-2xl shadow-lg relative group transition duration-300">
                ...
                <div className="mb-6">
                    ...
                    <div>
                        <span className="inline-block text-xs px-3 py-1 bg-white text-black rounded-full font-semibold">
